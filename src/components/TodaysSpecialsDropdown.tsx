    ...
    <Popover className="relative">
      {({ open, close }) => (
        <>
          ...
          >
            <CurrencyDollarIcon className="w-8 h-8 stroke-2 text-green-600" />
            ...
            <Popover.Panel className="fixed z-[9999] w-screen max-w-4xl px-4 mt-3 left-1/2 -translate-x-1/2 top-[200px] sm:px-0">
              <div className="overflow-hidden rounded-2xl shadow-xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700">
                <div className="relative flex flex-col px-6 py-6 space-y-6">
                  ...
                  <div className="overflow-y-auto max-h-[260px] scrollbar-thin scrollbar-thumb-neutral-300 dark:scrollbar-thumb-neutral-700 scrollbar-track-transparent pr-2">
